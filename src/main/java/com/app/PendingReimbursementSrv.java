...
public class PendingReimbursementSrv extends HttpServlet {
	
	private JdbcOperations jdbcOperations;
	
	public PendingReimbursementSrv() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Reimbursement> reimbursements = jdbcOperations.viewReimbursements(loggedInUser.getUserId(), "pending");
